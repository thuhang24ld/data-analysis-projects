"""
iPos Fabi - Crawl Hủy Món (sale-change-log-remove-item)
========================================================
Cài: pip install requests pandas openpyxl
Chạy: python crawl_huy_mon.py
"""
...
OUTPUT_DIR       = r"D:\Rooftop_IPos_data\Huy_mon"
TOKEN_CACHE_FILE = r"D:\Rooftop_IPos_data\.token_cache.json"

LOGIN_URL  = "https://posapi.ipos.vn/api/accounts/v1/user/login"
DETAIL_URL = "https://posapi.ipos.vn/api/v3/pos-cms/report/sale-change-log-remove-item"
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(os.path.join(OUTPUT_DIR, "crawler_huymon.log"), encoding="utf-8"),
    ]
)
...
def export_excel(records, d):
    filename = os.path.join(OUTPUT_DIR, f"huy_mon_{d}.xlsx")
    if not records:
...
if __name__ == "__main__":
    ...
    log.info(f"🚀 Crawl hủy món ngày {target}")
    try:
